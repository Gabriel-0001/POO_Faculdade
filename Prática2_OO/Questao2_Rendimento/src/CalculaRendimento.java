...
public class CalculaRendimento {
    ...
    public CalculaRendimento(float investimentoInicial, float taxaDoendimento, int numeroDeMeses) {
        this.investimentoInicial = investimentoInicial;
        this.taxaDoRendimento = taxaDoendimento;
    ...
    public void calculaRendimento(){
        for(int i =0; i <= numeroDeMeses; i++){
            ...
            System.out.printf("Rendimento no mes "+i+" = R$ %.2f",investimentoInicial);
            System.out.println();
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Qual a taxa de investimeno (somente numeros): ");
        float taxa = sc.nextFloat();
        System.out.println("Quantidade de meses que vai investir: ");
